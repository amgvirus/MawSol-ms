                ...
                >
                    <div className="flex flex-col h-full">
                        ...
                        <div className="flex items-center gap-3 px-6 h-16 border-b border-gray-100 dark:border-gray-700/50">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white text-lg shadow-lg shadow-primary-500/20">
                                🐔
                            </div>
                            <span className="font-bold text-gray-900 dark:text-white tracking-tight">
                                Poultry<span className="text-primary-500">Farm</span>
                            </span>
                            <button
                                onClick={() => setSidebarOpen(false)}
                            ...
                            {navigation.map((item) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        className={cn(
                                            'sidebar-item group',
                                            isActive ? 'active shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700/50'
                                        )}
                                    >
                                        <item.icon className={cn(
                                            'w-5 h-5 transition-colors',
                                            isActive ? 'text-primary-500' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-500 dark:group-hover:text-gray-300'
                                        )} />
                                        <span>{item.name}</span>
                                    </Link>
                                )
